...
[{{ activity.lab.title }}]({{ site.github.url }}{{ activity.url }}) <br/> {{ activity.lab.description }} <br/> <span class="meta-grey">レベル: {{activity.lab.level}} &nbsp; &nbsp; 期間: {{activity.lab.duration}} 分</span>

---

{% endfor %}
<a href="#overview">トップに戻る</a>
{% endfor %}
